The file Data.txt stores usernames and passwords of all users. Any computer running as the server needs to have this file and specify the directory to this file in the file Server.java
